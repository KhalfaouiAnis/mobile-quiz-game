        ...
        <Container backgroundColor="#00A6DA" header={<AuthHeader />}>
            <View className="flex-1 justify-center px-8 py-4 gap-y-6">
                <ViewWrapper>
                    ...
                    <Text className="text-center text-lg font-cairo-semibold mt-6">تم إعادة تعيين كلمة المرور الخاصة بك بنجاح.</Text>
                    <Text className="text-center text-lg font-cairo-semibold">انقر فوق "تأكيد" لتعيين كلمة مرور جديدة</Text>
                    <View className="w-1/4 mt-8 flex-1">
                        <AppButton title="تاكيد" onPress={() => router.push("/account_verification_confirmation")} />
                    </View>
                </ViewWrapper>
            </View>
        </Container>
