...
export default function StartGame2({ setCurrentStep }: { setCurrentStep: Dispatch<SetStateAction<number>> }) {
    return (
        <View className="flex-1 items-center justify-center">
            <View className="items-center justify-center flex-row gap-2">
                ...
                <View className="bg-error flex-row items-center gap-2 p-3">
                    ...
                    <Ionicons name="person-outline" color="#fff" size={20} style={{ fontWeight: "bold" }} />
                </View>
            </View>
