...
export default function FacebookIcon({ size = 40 }) {
    return (
        <Svg width={size} height={size} fill="none" viewBox="0 0 53 55">
            {/* <Defs>
                <LinearGradient id="paint0_linear_258_358" x1="0" y1="0" x2="0" y2="1" gradientUnits="objectBoundingBox">
                    <Stop offset="0" stopColor="#18ACFE" stopOpacity="1" />
                    <Stop offset="1" stop-color="#0163E0" stopOpacity="1" />
                </LinearGradient>
            </Defs>
            <Path
                fill="url(#paint0_linear_258_358)"
